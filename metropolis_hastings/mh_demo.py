...
next_memory = next_state.init_grouped_matrix(group_assignment.memory, [tp_links, tp_group_homo[0], tp_group_homo[1]])
next_homo_weighted = next_state.init_grouped_matrix(group_assignment.walker, tp_group_homo_weighted)
next_memory_weighted = next_state.init_grouped_matrix(group_assignment.memory, [tp_links, tp_group_homo_weighted[0], tp_group_homo_weighted[1]])
...
print(init_state)
samples, burnin_samples, accepted_samples, map_estimate, map_estimate_list, log = metropolis_hastings(init_state, calc_values, 100, 0.5, dirichlet_proposal)
print(map_estimate)
